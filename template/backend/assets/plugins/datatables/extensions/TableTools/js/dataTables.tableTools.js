...
TableTools.prototype = {
	 ...
	 *  @param   {String} text Text.php to set
	 */
	 ...
	 * indicates which columns we want to component
	 *  @method  _fnColumnTargets
	 *  @param   {String|Array} mColumns The columns to be included in data retrieval. If a string
	 *			 then it can take the value of "visible" or "hidden" (to component all visible or
